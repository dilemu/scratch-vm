...
/**
 * Manage communication with a Arduino peripheral over a DBit+ Link client socket.
 */
class ArduinoPeripheral{

    /**
     * Construct a Arduino communication object.
     * @param {Runtime} runtime - the DBit+ runtime
    ...
    constructor (runtime, deviceId, originalDeviceId, pnpidList, serialConfig, diveceOpt) {
        /**
         * The DBit+ runtime used to trigger the green flag button.
         * @type {Runtime}
         * @private
         */
