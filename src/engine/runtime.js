...
class Runtime extends EventEmitter {
    constructor () {
        ...
        this.REMOTE_HOST = "http://139.196.77.69:60002";
        this.uuid = uid();
    ...
    _convertButtonForScratchBlocks (buttonInfo) {
        ...
        const supportedCallbackKeys = ['MAKE_A_LIST', 'MAKE_A_PROCEDURE', 'MAKE_A_VARIABLE', 'trainModel', 'startImgPredict'];
    ...
    getLabelForOpcode (extendedOpcode) {
        ...
        return {
            ...
            label: `${block.info.label || block.info.text}`
        };
    }
