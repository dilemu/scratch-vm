...
class VirtualMachine extends EventEmitter {
    constructor () {
        ...
        this.runtime.on(Runtime.FORCE_REFRESH_WORKSPACE, () => {
            this.emit(Runtime.FORCE_REFRESH_WORKSPACE);
        });
    ...
    installTargets (targets, extensions, wholeProject, hasDevice, projectJSON) {
        const allPromises = [];
