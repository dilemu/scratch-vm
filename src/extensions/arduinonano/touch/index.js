...
class ArduinoNanoTouch {
    ...
    static get STATE_KEY() {
        return 'Scratch.ArduinoNanoTouch';
    }
     ...
     */
    _getState(target) {
        let state = target.getCustomState(ArduinoNanoTouch.STATE_KEY);
        if (!state) {
            state = Clone.simple(ArduinoNanoTouch.DEFAULT_HELLOWORLD_STATE);
            target.setCustomState(ArduinoNanoTouch.STATE_KEY, state);
        }
        return state;
    }
...
module.exports = ArduinoNanoTouch;